...
The server communicates over stdio and is designed for use with Claude Code CLI, which
spawns MCP servers as child processes. It connects to the same observability stack as
the API services and emits the [MCP telemetry signals](../../README.md#mcp-telemetry-signals) defined in the project
root.
...
make mcp-add       # Register this MCP server with Claude Code
